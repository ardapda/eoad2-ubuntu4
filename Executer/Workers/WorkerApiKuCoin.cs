...
namespace Executer.Workers
{
    class WorkerApiKuCoin : WorkerApi
    {
        ...
        public static string RunFromCmd(string[] args)
        {
            ...
            try
            {
                PSI.Arguments = string.Format("{0} {1} {2} {3} {4} {5} {6} {7}", script, args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
